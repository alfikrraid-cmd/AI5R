...
const GENERIC_TAB_KEYS=new Set(["dashboard","pump","seal","drawing","document","installation","workorder","pm","cm","cmon","knowledgereview","import","reports","analytics","historical-review"]);
