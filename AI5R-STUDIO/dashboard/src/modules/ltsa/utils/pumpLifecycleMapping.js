...
function mapCurrentState(currentState) {
  ...
  return {
    ...
    lastConditionMonitoring: currentState.last_condition_monitoring ?? null,
    lastSealReplacement: currentState.last_seal_replacement ?? null,
    lastConfirmedSealFailure: currentState.last_confirmed_seal_failure ?? null,
