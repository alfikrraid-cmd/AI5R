...
Concrete AIExecutive responsible for technology domain oversight.
...
class ChiefTechnologyOfficer(AIExecutive):
    ...
    def plan(self, work_order: ExecutiveWorkOrder) -> dict[str, Any]:
        ...
        return {
            ...
            "success_criteria": list(work_order.success_criteria),
            "steps": list(work_order.requested_roles),
        }
