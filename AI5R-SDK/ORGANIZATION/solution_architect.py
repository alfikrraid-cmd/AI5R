...
Concrete AIExecutive responsible for technical architecture oversight.
...
EXECUTIVE_ID = "EXEC-SA-001"
EXECUTIVE_NAME = "Solution Architect"
DEPARTMENT = "ARCHITECTURE"
AUTHORITY_LEVEL = "C-LEVEL"


class SolutionArchitect(AIExecutive):
    ...
    def plan(self, work_order: ExecutiveWorkOrder) -> dict[str, Any]:
        ...
        return {
            "architecture_name": work_order.work_order_id,
            "product_name": work_order.metadata.get(
                "product_name", work_order.work_order_id
            ),
            "modules": list(work_order.requested_roles),
            "services": [],
            "apis": [],
            "database": [],
